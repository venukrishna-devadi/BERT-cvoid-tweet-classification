...
raw_data = pd.read_csv('CDCtravel_tweets_unique.csv')
raw_data.columns
...
# Extract the test accuracy from the history
...
unlabelled_data.to_csv('CDCtravel_tweets_unique_new_predictions.csv', index=True)
