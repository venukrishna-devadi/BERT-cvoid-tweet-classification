...
# Loading the dataset
raw_data = pd.read_csv('CDCFLu_tweets_unique_500labelled.csv')

# preprocess the data using regular expressions
...
unlabelled_data.to_csv('CDCFLu_tweets_unique_new_predictions.csv', index=True)
