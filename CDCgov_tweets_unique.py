...
raw_data = pd.read_csv('/Users/venu/Documents/Productivity/saint peters masters/GA/project/twitterdatacollection (2)/GA_Project_TwitterSentimentAnalysis/Twitter_covid_classification/CDCgov_tweets_unique_500_labelled.csv')
raw_data.columns
...
raw_data_1 = raw_data[["clean_text", 'Labels']][:499]
...
unlabelled_data.to_csv('CDCgov_tweets_unique_new_predictions.csv', index=True)
