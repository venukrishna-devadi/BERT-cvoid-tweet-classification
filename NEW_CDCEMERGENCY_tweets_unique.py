...
# -*- coding: utf-8 -*-
"""
Created on Tue May  9 14:49:02 2023
...
raw_data = pd.read_csv('CDCemergency_tweet_new_predictions.csv.csv')
raw_data.columns
raw_data.shape
...
unlabelled_data.to_csv('CDCemergency_tweet_new_predictions.csv', index=True)
